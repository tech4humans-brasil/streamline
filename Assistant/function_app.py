...
GOOGLE_CREDS = {
    "type": os.environ["GOOGLE_CREDS_TYPE"],
    "project_id": os.environ["GOOGLE_CREDS_PROJECT_ID"],
    "private_key_id": os.environ["GOOGLE_CREDS_PRIVATE_KEY_ID"],
    "private_key": os.environ["GOOGLE_CREDS_PRIVATE_KEY"],
    "client_email": os.environ["GOOGLE_CREDS_CLIENT_EMAIL"],
    "client_id": os.environ["GOOGLE_CREDS_CLIENT_ID"],
    "auth_uri": os.environ["GOOGLE_CREDS_AUTH_URI"],
    "token_uri": os.environ["GOOGLE_CREDS_TOKEN_URI"],
    "auth_provider_x509_cert_url": os.environ["GOOGLE_CREDS_AUTH_PROVIDER_X509_CERT_URL"],
    "client_x509_cert_url": os.environ["GOOGLE_CREDS_CLIENT_X509_CERT_URL"],
    "universe_domain": os.environ["GOOGLE_CREDS_UNIVERSE_DOMAIN"],
}
...
def ping(req: func.HttpRequest) -> func.HttpResponse:
    ...
    logging.info("Python HTTP trigger function processed a request. Ping" + creds["type"])
...
def form_assistant(req: func.HttpRequest) -> func.HttpResponse:
    ...
    try:
        ...
        types = litellm.completion(
            ...
            base_url=LLM_URI,
            messages=messages,
            vertex_credentials=GOOGLE_CREDS,
            **additional_params,
        )
