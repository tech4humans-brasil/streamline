import { handler } from "./MyPendingInteractions";
...
describe("MyPendingInteractions API handler", () => {
  let mockConn;
  let mockReq;
  let mockRes;
  ...
  it("should return my pending interactions", async () => {
  ...
  it("should return an empty array if no pending interactions are found", async () => {
  ...
  it("should handle errors", async () => {
    ...
    expect(res.notFound).toHaveBeenCalledWith("Error retrieving pending interactions");
  });
});
